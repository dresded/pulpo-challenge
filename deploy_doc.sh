...
S3_BUCKET=${S3_BUCKET:?--bucket or -b parameter. This is the S3 bucket which will host documentation. }
...
then
  ...
  # replace reference inside swagger-initializer.js (new spot instead of index.html: march-2022)  from https://petstore.swagger.io/v2/swagger.json to openapi.yml (generated swagger file) using sed
  sed -i '' 's/https:\/\/petstore.swagger.io\/v2\/swagger.json/openapi.yml/g' ./swagger-ui/dist/swagger-initializer.js 
